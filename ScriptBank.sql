...
CREATE TABLE IF NOT EXISTS `mydb`.`Transitions` (
  ...
  PRIMARY KEY (`Bank_id`, `BankStatement_id`),
  INDEX `fk_Bank_has_BankStatement_BankStatement1_idx` (`BankStatement_id` ASC) VISIBLE,
  INDEX `fk_Bank_has_BankStatement_Bank1_idx` (`Bank_id` ASC) VISIBLE,
  CONSTRAINT `fk_Bank_has_BankStatement_Bank1`
    FOREIGN KEY (`Bank_id`)
    REFERENCES `mydb`.`Bank` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Bank_has_BankStatement_BankStatement1`
